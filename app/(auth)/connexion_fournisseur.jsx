...
const Connexion = ({ onLoginSuccess }) => {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground source={require('@/assets/images/for.jpeg')} style={styles.backgroundImage}>
        <View style={styles.overlay}>
          <Text style={styles.title}>Connexion Fournisseur</Text>
          ...
          <View style={styles.inputContainer}>
            ...
            <TouchableOpacity onPress={() => setShowPassword(!showPassword)}>
              <FontAwesome name={showPassword ? "eye-slash" : "eye"} size={20} color="#00aeef" />
            </TouchableOpacity>
          </View>
